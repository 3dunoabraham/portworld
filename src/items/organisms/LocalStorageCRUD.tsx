    ...
    return (
        <div className="flex-col  flex-align-stretch  ">
            ...
            <hr className="my-2 Q_xs_md"/>
                <ItemsTable  displayConfigObj={tableConfigObj} boolConfig={["isErasable", "isCompact"]}
                theArray={theJsonArray} urlBase="/user/"  deleteUnit={(id)=>{alert("delete from localhost: "+id)}} 
            /> 
