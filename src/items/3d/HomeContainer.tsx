        ...
        <div className="flex pos-abs bottom-0 right-0  bord-r- pa-2 ma-2">
            <div className="flex-col flex-align-stretch z-700 gap-1 ">
                ...
                <div className="flex-col gap-1 opaci-50 tx-ls-">
                    {/* <div className="flex py-1 px-2 bg-w-10 bord-r- opaci-chov--50">{parseInt(""+xOut*2)}</div> */}
        ...
        <div className="flex pos-abs top-0 left-0  bord-r- pa-2 ma-2">
            <div className="flex-col flex-align-stretch z-700 gap-1 tx-white mt-100">
                ...
                <div className="flex-center gap-1">
                    ...
                    {/* <div className="flex bg-w- bord-r- opaci-chov--50">{parseInt(""+roofHeight)}'</div> */}
                </div>
                {/* {Object.keys(DEFAULT_CARPORT_OTPS).map((aCarportOpt, index) => {
                    return (
                        <div className="flex" key={index}>
                            <button className={`flex w-100 pa-1 bord-r- px-2 opaci-chov--50  ${!optsToggler[aCarportOpt].bool ? "box-shadow-2" : "bg-b-10"}`}
                                onClick={()=>{toggleOption(aCarportOpt)}}
                            >
                                {aCarportOpt}
                            </button>
                        </div>
                ...
                <div className="flex-col flex-align-stretch gap-2 rot-180">
                    ...
                    <div className="flex gap-1">
                        ...
                        <button onClick={()=>{toggleOption("rightwall")}} 
                            style={{filter: "hue-rotate(-189deg) brightness(666%)", transform:"rotate(180deg)"}}
